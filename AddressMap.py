...
p1_end_of_move_cancelable_frames = 0x14455B3D0 #for tira AA is 11/12, this is 0 when no move is active
p2_end_of_move_cancelable_frames = 0x14455B5B0

p1_total_animation_frames = 0x1445A7D80 #for Tira AA is 52/56, remember this is a FLOAT
p2_total_animation_frames = 0x14463EA90

p1_last_attack_address = 0x1445A7460 #for Tira A is 0x3730, K is 0x5aa0 and A+B is 0x62f0, search for the offsets from one to the next
